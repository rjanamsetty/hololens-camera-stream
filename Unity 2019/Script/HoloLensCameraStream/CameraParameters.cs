...
namespace HoloLensCameraStream
{
    ...
    public struct CameraParameters
    {
        ...
        /// </summary>
        public readonly bool rotateImage180Degrees;
        ...
        {
            get => videoStabilizationBufferSize > 0;
            set => videoStabilizationBufferSize = value ? 15 : 0;
        }

        /// <summary>
        /// Defines the camera parameters of selected camera stream.
        /// </summary>
        /// <param name="pixelFormat">The pixel format of the stream</param>
        /// <param name="cameraResolutionHeight">The height of the stream</param>
        /// <param name="cameraResolutionWidth">The width of the stream</param>
        /// <param name="frameRate">The framerate of the stream</param>
        /// <param name="rotateImage180Degrees">Whether or not the camera was rotated 180 degrees</param>
